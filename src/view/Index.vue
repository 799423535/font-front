  ...
  <van-overlay :show="show" @click="close">
    <div class="wrapper">
      <div class="block" @click.stop>
        <span class="wz">分享艺术生活</span>
        <ul class="list">
          <li>
            <img src="/@/assets/slices/sliceimages/icon01.png" alt="" />
            <p>发图片</p>
          </li>
          <li>
            <img src="/@/assets/slices/sliceimages/icon02.png" alt="" />
            <p>短视频</p>
          </li>
          <li>
            <img src="/@/assets/slices/sliceimages/icon03.png" alt="" />
            <p>发作品</p>
          </li>
          <li>
            <img src="/@/assets/slices/sliceimages/icon04.png" alt="" />
            <p>提问题</p>
          </li>
        </ul>
      </div>
